  ...
  const [noticias, setNoticias] = useState<Noticia[]>([
    {
      ...
      tema: 'Economía',
      porcentaje: 85,
      url: 'https://www.clarin.com/noticia1',
      contenido: 'El gobierno anunció nuevas medidas económicas...'
    },
    {
      id: '2',
      ...
      tema: 'Tecnología',
      porcentaje: 92,
      url: 'https://www.lanacion.com/noticia2',
      contenido: 'Investigadores presentaron avances en IA...'
    },
    {
      id: '3',
      ...
      tema: 'Economía',
      porcentaje: 78,
      url: 'https://www.infobae.com/noticia3',
      contenido: 'Las exportaciones agrícolas crecieron...'
    },
    {
      id: '4',
      ...
      tema: 'Educación',
      porcentaje: 88,
      url: 'https://www.pagina12.com/noticia4',
      contenido: 'Se debate en el Congreso la reforma educativa...'
    },
    {
      id: '5',
      ...
      tema: 'Tecnología',
      porcentaje: 91,
      url: 'https://www.ambito.com/noticia5',
      contenido: 'Bancos implementan nuevas tecnologías...'
    },
    {
      id: '6',
      ...
      tema: 'Economía',
      porcentaje: 76,
      url: 'https://www.clarin.com/noticia6',
      contenido: 'Expertos analizan el comportamiento del mercado...'
    }
  ]);
                    ...
                    <table className="min-w-full">
                      <thead className="bg-black/20">
                        <tr>
                          ...
                          <th className="px-6 py-4 text-left text-xs font-bold text-white/80 uppercase tracking-wider">Noticia</th>
                          <th className="px-6 py-4 text-center text-xs font-bold text-white/80 uppercase tracking-wider">Medio</th>
                          <th className="px-6 py-4 text-center text-xs font-bold text-white/80 uppercase tracking-wider">Fecha</th>
                          <th className="px-6 py-4 text-center text-xs font-bold text-white/80 uppercase tracking-wider">Sentimiento</th>
                          <th className="px-6 py-4 text-center text-xs font-bold text-white/80 uppercase tracking-wider">Confianza</th>
                        </tr>
                      </thead>
                      <tbody className="divide-y divide-white/10">
                        {noticiasFiltradas.map((noticia) => (
                          <tr key={noticia.id} className="hover:bg-black/20 transition-colors duration-200">
                            ...
                            <td className="px-6 py-4">
                              <div className="text-sm font-semibold text-white max-w-xs">{noticia.titulo}</div>
                            </td>

    ...
    >
      ...
      <div className="p-8">
        <Button 
          ...
          variant="ghost"
          size="lg"
          className="w-full justify-start px-6 py-5 text-white/90 hover:text-white hover:bg-white/10"
        >
        ...
        <>
          ...
          <div className="p-8">
            ...
            <Button 
              ...
              variant="ghost"
              size="lg"
              className="w-full justify-start px-6 py-5 text-white/90 hover:text-white hover:bg-white/10 mb-4"
            >
              <div className="w-12 h-12 bg-green-500/20 rounded-xl flex items-center justify-center mr-5">
            ...
            <Button 
              ...
              className="w-full justify-start px-6 py-5 text-white/90 hover:text-white hover:bg-white/10 mb-4"
            >
              <div className="w-12 h-12 bg-blue-500/20 rounded-xl flex items-center justify-center mr-5">
            ...
            <Button 
              ...
              className="w-full justify-start px-6 py-5 text-white/90 hover:text-white hover:bg-white/10"
            >
              <div className="w-12 h-12 bg-purple-500/20 rounded-xl flex items-center justify-center mr-5">
      ...
      <div className="p-8">
        <Button 
          ...
          variant="ghost"
          size="lg"
          className="w-full justify-start px-6 py-5 text-red-400 hover:text-red-300 hover:bg-red-500/10"
        >
          <div className="w-12 h-12 bg-red-500/20 rounded-xl flex items-center justify-center mr-5">
